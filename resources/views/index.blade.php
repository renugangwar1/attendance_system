...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <!-- Spacer to push the right content to the end -->
        <div class="ms-auto d-flex align-items-center">
            ...
            <div class="me-3 position-relative">
                ...
                <div class="dropdown-menu" aria-labelledby="notificationButton" id="notificationList">
                    <p class="dropdown-item">No new messages</p>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6">
                        <div class="card bg-primary text-white mb-4">
                            <div class="card-body"> Faculty <h3>{{ $facultyCount }}</h3>
                            </div>
                            <div class="card-footer d-flex align-items-center justify-content-between">
                                <a class="small text-white stretched-link" href="{{ route('admin.faculties') }}">View
                                    Details</a>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card bg-success text-white mb-4">
                            <div class="card-body">Students <h3>{{ $studentCount }}</h3>
                            </div>
                            <div class="card-footer d-flex align-items-center justify-content-between">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card bg-warning text-white mb-4">
                            <div class="card-body">Visitors <h3>{{ $visitorCount }}</h3>
                            </div>
                            <div class="card-footer d-flex align-items-center justify-content-between">
