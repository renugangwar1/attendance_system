        ...
        <div class="col-md-8">
            <div class="card shadow-lg rounded-4 border-0">
                ...
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('form.faculty.submit') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <video id="video" width="100%" height="300" autoplay class="rounded border mb-2"></video>
                            <canvas id="canvas" width="640" height="480" style="display:none;"></canvas>
                            <input type="hidden" name="image_data" id="image_data">
                            <button type="button" id="capture" class="btn btn-sm btn-secondary mb-2">📸 Capture</button>
                            <div>
                                <img id="preview" src="" style="max-width:100%; display:none;" class="img-thumbnail">
                            </div>
                        </div>

                        <div class="text-center">
                            <button type="submit" class="btn btn-gradient-primary px-4">Submit</button>
                        </div>
                    </form>
                </div>
                @endif
            ...
            document.addEventListener('DOMContentLoaded', async function() {
                ...
                // Add hidden input for face descriptor
                const descriptorInput = document.createElement('input');
                descriptorInput.type = 'hidden';
                descriptorInput.name = 'face_descriptor';
                descriptorInput.id = 'face_descriptor';
                document.querySelector('form').appendChild(descriptorInput);
                ...
                captureBtn.addEventListener('click', async () => {
                    ...
                    const detection = await faceapi.detectSingleFace(canvas, new faceapi
                        .TinyFaceDetectorOptions()).withFaceLandmarks().withFaceDescriptor();
